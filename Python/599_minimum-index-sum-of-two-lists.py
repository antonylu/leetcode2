...
if __name__ == '__main__':
    s = Solution()
    tc  = [ (["Shogun", "Tapioca Express", "Burger King", "KFC"], ["Piatti", "The Grill at Torrey Pines", "Hungry Hunter Steakhouse", "Shogun"]), \
            (["Shogun", "Tapioca Express", "Burger King", "KFC"], ["KFC", "Shogun", "Burger King"]) ]

    ans = [ ["Shogun"], ["Shogun"] ]

    for i in range(len(tc)):
        r = s.findRestaurant(tc[i][0],tc[i][1])
        print (r)
        assert(r == ans[i])
